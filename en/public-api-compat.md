...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (Duplicate/incomplete version of 'Delete Port' (k23); lacks a Response subheading and is superseded by t25 which is the better match for k23.) -->
<a id="delete-port"></a>
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (Request subheading under the duplicate t23 'Delete a port' section; has no distinct ko counterpart beyond k24 which is matched to t26.) -->
