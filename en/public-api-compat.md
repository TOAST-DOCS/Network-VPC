...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (Duplicate of t25 'Delete Port' (maps to k23 '포트 삭제하기'); t23 is a redundant partial duplicate heading with no distinct ko counterpart.) -->
<a id="delete-port"></a>
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (Child of extra t23; duplicate Request heading under the spurious 'Delete a port' section with no distinct ko counterpart.) -->
